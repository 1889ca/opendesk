...
/**
 * Computes a deterministic 64-char hex revision ID from a Yjs state vector.
 * Uses SHA-256 so the result satisfies the RevisionIdSchema constraint.
 */
export function computeRevisionId(stateVector: Uint8Array): string {
