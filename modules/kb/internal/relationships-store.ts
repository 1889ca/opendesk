...
export async function createRelationship(input: CreateRelationshipInput): Promise<KBRelationship> {
...
export async function deleteRelationship(workspaceId: string, id: string): Promise<boolean> {
