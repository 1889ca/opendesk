...
export interface KbEntryStore {
  ...
  getEntry(id: string): Promise<KbEntryRow | null>;
  listEntries(workspaceId: string, statusFilter?: KbEntryStatus): Promise<KbEntryRow[]>;
  listPublishedEntries(workspaceId: string): Promise<KbEntryRow[]>;
  updateEntry(id: string, updatedBy: string, updates: KbEntryFields): Promise<KbEntryRow | null>;
  transitionStatus(id: string, newStatus: KbEntryStatus): Promise<KbEntryRow | null>;
  deleteEntry(id: string): Promise<boolean>;
}

export function createKbEntryStore(pool: Pool): KbEntryStore {
  /**
  ...
  async function getEntry(id: string): Promise<KbEntryRow | null> {
  ...
  async function listPublishedEntries(workspaceId: string): Promise<KbEntryRow[]> {
  ...
  return { createEntry, getEntry, listEntries, listPublishedEntries, updateEntry, transitionStatus, deleteEntry };
}
