...
function renderDialog(): HTMLElement {
  ...
  el.addEventListener('click', (e) => {
    if (e.target === el) closeShortcutDialog();
  });
...
export function openShortcutDialog(): void {
  ...
  const closeBtn = overlay.querySelector('.shortcut-close') as HTMLElement;
  closeBtn?.focus();

  document.addEventListener('keydown', handleDialogKeys);
}

/** Close the keyboard shortcut help dialog. */
...
/** Bind the Ctrl/Cmd+/ shortcut to open the dialog. */
